...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
             <div  class="form">
                 <form action="" method="POST" name="reg_form" id="reg_form" class="p-3">
                     ...
                     <div class="form-group">
                     <label for="Personel" class="label"> Male :</label>
                      <input type="radio" name="gender" id="gender" class="radio"  value="Male">
                      <br>
                      <label for="" class="label">Female :</label>
                     ...
                     <br>
                   <button name="register" class="btn btn-primary" id="button">REGISTER</button>
