...
<body>
  ...
  <div class="form-group">
   <h4>ID</h4>
    <input type="text" class="form-control" id="id" name="id" aria-describedby="Help" placeholder="ID " value="CLT " required>
  ...
  <h4>USER NAME</h4>
   ...
   <div class="form-group p-3" >
       <button class="btn btn-danger btn-lg" name="delete" id="delete">Remove</button>
