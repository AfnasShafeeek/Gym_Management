...
<body>
    <div class="head" align="center"> 
     ...
     <div class="Add m-4 p-4" align="right">
        <a href="trainer_reg.php" style="text-decoration: none;">
    <button class="btn btn-primary btn-lg">Add Trainer</button>
       </a>

       <a href="trainer_remove.php" style="text-decoration: none;">
    <button class="btn btn-danger btn-lg">Remove Trainer</button>
       </a>
    ...
    <table class="table p-2 m-4" border="1px" >
        <thead>
            <tr>
                ...
                <th class="text-center p-3">Salary</th>
                <th class="text-center p-3"> Account Number</th>
